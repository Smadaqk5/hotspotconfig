"""
Django settings for hotspot_config project.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-change-this-in-production-please-use-a-secure-key')
...
if DEBUG:
    ...
    # Production: allow all hosts or specific ones
...
WSGI_APPLICATION = 'hotspot_config.wsgi.application'
...
PESAPAL_BASE_URL = config('PESAPAL_BASE_URL', default='https://cybqa.pesapal.com/pesapalv3/api/')
